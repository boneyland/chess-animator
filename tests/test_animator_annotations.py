...
from animator_game import CommentaryPanel, MoveData, MoveListPanel
...
class OverlongCommentsTest(unittest.TestCase):
    ...
    def test_reports_move_comments_longer_than_the_panel(self):
        ...
        self.assertEqual(CommentaryPanel.overlong_comments(comments),
                         [("35", len(CommentaryPanel._wrap(long_text)))])
